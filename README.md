...
Other Style Guides
  ...
  - [React](react/)
  - [CSS-in-JavaScript](docs/css-in-javascript/)
...
## Semicolons
  ...
  <a name="semicolons--never"></a><a name="20.1"></a>
  - [21.1](#semicolons--never) **Yup.** eslint: [`semi`](https://eslint.org/docs/rules/semi.html)

...
module.exports = declare((api, options) => {
  ...
  const useFlow = typeof options.useFlow === 'boolean' ? options.useFlow : false
  const reactOptions = typeof options.react === 'object' ? options.react : {enable: false}
  ...
  if (reactOptions.enable) {
    presets.push([require('@babel/preset-react'), {development, ...reactOptions}])
  }
  return {
    presets,
    plugins: [
      reflectiveBind.enable
        ? [
          require('reflective-bind/babel'),
          {...reflectiveBind}
          ] 
        : null,
      looseClasses
      ...
      useFlow ? require('@babel/plugin-transform-flow-strip-types') : null,
